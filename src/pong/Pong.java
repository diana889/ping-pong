	...
	public void render(Graphics2D g)
	{
		...
		if (gameStatus == 0)
		{
			...
			if (!selectingDifficulty)
			{
				...
				g.drawString("Press Shift to Play with Bot", width / 2 - 200, height / 2 + 
...
/ 2 + 75);
		...
		if (selectingDifficulty)
		{
			String string = botDifficulty == 0 ? "Easy" : (botDifficulty == 1 ? "Medium" : 

"Hard");

			g.setFont(new Font("Arial", 1, 30));

			g.drawString("<< Bot Difficulty: " + string + " >>", width / 2 - 180, height / 2 - 
